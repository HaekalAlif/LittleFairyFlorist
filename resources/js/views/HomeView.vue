    ...
    <MainLayout>
                        ...
                        <main class="flex flex-col text-base text-red-400 rounded-none">
                            <section
                                ...
                                <p
                                    ...
                                    menghadirkan kesempurnaan yang menyentuh
                                    hati. Dari bunga segar yang indah hingga
                                    rangkaian elegan yang unik, kami menciptakan
                                    momen tak terlupakan untuk setiap kesempatan
                                    spesial Anda.
                                </p>
                                <a href="/order">
                                    <button
                    ...
                    <div class="flex gap-5 max-md:flex-col">
                        <article class="flex flex-col w-3/12 max-md:ml-0 max-md:w-full">
                            <div
                                ...
                                <h2 class="mt-12 text-2xl font-semibold tracking-tight max-md:mt-10">
                                    Memilih Bunga
                                </h2>
                                <p class="self-stretch mt-6 text-sm tracking-tight leading-6">
                        ...
                        <article class="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
                            <div
                                ...
                                <h2 class="mt-12 text-xl font-semibold tracking-tight max-md:mt-10">
                                    Reservasi Pemesanan
                                </h2>
                                <p class="self-stretch mt-7 text-sm tracking-tight leading-6">
        ...
        <section class="">
            <div class="flex flex-col items-center px-1 w-full bg-orange-100 max-md:max-w-full">
                ...
                <section class="flex flex-col w-full px-20 pt-16 pb-20 bg-red-200 max-md:px-5 max-md:pt-24">
                    ...
                    <img loading="lazy" src="/public/assets/images/pemisah.png" alt="Showcase of flower arrangements"
                                ...
                                <div class="flex flex-col grow max-md:mt-8">
                                    <div
                                        ...
                                        <div class="flex flex-col pb-2.5 mt-9 rounded-3xl max-md:mx-1">
                                            <img loading="lazy" src="/public/assets/images/buket1.png"
                                                alt="Sweet Serenity flower arrangement"
                                                class="object-contain z-10 -mt-2.5 w-full rounded-3xl aspect-[1.13]" />
                                        </div>
                                        <button
                                ...
                                <div class="flex flex-col grow max-md:mt-8">
                                    <div
                                        ...
                                        <img loading="lazy" src="/public/assets/images/buket3.png"
                                            ...
                                            class="object-contain self-start mt-6 w-full rounded-3xl aspect-[1.13]" />
                                        <button
                                ...
                                <div class="flex flex-col grow max-md:mt-8">
                                    <div
                                        ...
                                        <img loading="lazy" src="/public/assets/images/buket4.png"
                                            ...
                                            class="object-contain mt-5 w-full rounded-3xl aspect-[1.13] max-md:mr-2 max-md:ml-1" />
                                        <button
                            ...
                            <article class="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
                                <figure
                                    ...
                                    <img loading="lazy"
                                        ...
                                        alt="Advertisement 1" class="object-contain w-full aspect-[1.12]" />
                                </figure>
                            </article>
                            <article class="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                                <figure
                                    ...
                                    <img loading="lazy"
                                        ...
                                        alt="Advertisement 2" class="object-contain w-full aspect-[1.12]" />
                                </figure>
                            </article>
                            <article class="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                                <figure
                                    ...
                                    <img loading="lazy"
                                        ...
                                        alt="Advertisement 3" class="object-contain w-full aspect-[1.12]" />
                                </figure>
                            </article>
                        </div>
                    </div>
                ...
                <section class="flex flex-col rounded-none">
                    <div
                        ...
                        <p class="mt-8 text-lg leading-7 text-center text-red-400 max-md:max-w-full">
                            ...
                            merasakan keindahan dan makna dalam setiap rangkaian
                        ...
                        <div
                            ...
                            <div class="grid grid-cols-3 gap-5 max-md:grid-cols-1 max-md:ml-0 max-md:w-full">
                                <article>
                                    <div
                                        class="flex flex-col px-11 py-7 mx-auto w-full text-white bg-red-400 rounded-xl max-md:px-5 max-md:mt-10">
                                        <div class="flex gap-5 items-start self-start ml-3 text-center max-md:ml-2.5">
                                            <img class="flex shrink-0 w-10 h-10 bg-white rounded-full"
                                                src="/public/assets/images/profile/profil-1.png" alt="" />
                                            <div class="flex flex-col mt-2.5">
                                                <h3 class="self-start text-lg font-medium leading-loose">
                                                    FufuFafa
                                                </h3>
                                                <p class="mt-2.5 text-sm leading-loose">
                                ...
                                <article>
                                    <div
                                        ...
                                        <div class="flex gap-5 items-start self-start ml-3 text-center max-md:ml-2.5">
                                            <img class="flex shrink-0 w-10 h-10 bg-white rounded-full"
                                                src="/public/assets/images/profile/profil-2.png" alt="" />
                                ...
                                <article>
                                    <div
                                        ...
                                        <div class="flex gap-5 items-start self-start ml-3 text-center max-md:ml-2.5">
                                            <img class="flex shrink-0 w-10 h-10 bg-white rounded-full"
                                                src="/public/assets/images/profile/profil-3.png" alt="" />
                                            <div class="flex flex-col mt-2">
                                                <h3 class="self-start text-lg font-medium leading-loose">
                                                    Izzati Putri
                                                </h3>
                            ...
                            <div
                                ...
                                <div class="flex gap-4 my-auto">
                                    <img loading="lazy"
                                        ...
                                        class="object-contain shrink-0 aspect-[3] w-[45px]" alt="Decorative element" />
                                    <span
                                        class="flex shrink-0 rounded-full bg-stone-400 bg-opacity-50 h-[15px] w-[15px]"></span>
                                    <span
                                        class="flex shrink-0 rounded-full bg-stone-400 bg-opacity-50 h-[15px] w-[15px]"></span>
                                    <span
                                        class="flex shrink-0 rounded-full bg-stone-400 bg-opacity-50 h-[15px] w-[15px]"></span>
