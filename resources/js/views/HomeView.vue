    ...
    <MainLayout>
            ...
            <header class="flex flex-col w-full max-md:max-w-full">
                ...
                >
                    <div class="flex flex-col bg-red-200 max-md:max-w-full">
                        ...
                        >
                            <section
                                class="flex flex-col rounded-none overflow-x-hidden"
                            >
                                <div
                                    class="relative flex flex-col items-start px-12 pt-52 w-full min-h-[816px] max-md:px-5 max-md:py-24 max-md:max-w-full"
                                >
                                    <img
                                    ...
                                    />
                                    <div
                                        class="relative card p-5 rounded-lg w-full max-w-[420px] mt-14 flex flex-col items-start"
                                    >
                                        <h1
                                            class="gap-2.5 self-stretch text-5xl font-bold leading-none uppercase max-md:text-4xl mb-6 text-center"
                                        >
                                            little fairy florist
                                        </h1>
                                        <p
                                            class="ml-3 font-bold tracking-tight leading-7 text-justify"
                                        >
                                            Bawa keindahan yang bermakna dalam
                                            hidup Anda dengan rangkaian bunga
                                            dari Little Fairy Florist. Setiap
                                            buket kami susun dengan penuh cinta
                                            dan perhatian, menghadirkan
                                            kesempurnaan yang menyentuh hati.
                                            Dari bunga segar yang indah hingga
                                            rangkaian elegan yang unik, kami
                                            menciptakan momen tak terlupakan
                                            untuk setiap kesempatan spesial
                                            Anda.
                                        </p>

                                        <a href="/order">
                                            <button
                                                class="relative gap-2 self-center px-5 mt-9 mb-0 font-semibold tracking-tight text-center text-orange-100 bg-red-400 rounded min-h-[44px] w-[150px] max-md:mb-2.5 max-md:ml-2.5 outline-none"
                                            >
                                                Pesan Sekarang
                                            </button>
                                        </a>
                        ...
                        >
                            ...
                            <div
                                class="flex shrink-0 my-auto w-5 h-5 bg-rose-100 rounded-full hidden md:block"
                            ></div>
                            ...
                            <div
                                class="flex shrink-0 my-auto w-5 h-5 bg-rose-100 rounded-full hidden lg:block"
                            ></div>
                            ...
                            <div
                                class="flex shrink-0 my-auto w-5 h-5 bg-rose-100 rounded-full hidden xl:block"
                            ></div>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="flex gap-5 max-md:flex-col max-md:gap-8">
                        <article class="flex flex-col w-3/12 max-md:w-full">
                            ...
                            >
                                ...
                                <h2
                                    class="mt-12 text-2xl font-semibold tracking-tight max-md:mt-10 text-center"
                                >
                                    Memilih Bunga
                                </h2>
                                <p
                                    class="self-stretch mt-6 text-sm tracking-tight leading-6 text-center"
                                >
                                    Memilih berbagai jenis Bucket yang tersedia,
                                    sesuai kebutuhan atau preferensi
                                </p>
                            </div>
                        </article>
                        ...
                        <article class="flex flex-col w-3/12 max-md:w-full">
                            ...
                            >
                                ...
                                <h2
                                    class="mt-12 text-xl font-semibold tracking-tight max-md:mt-10 text-center"
                                >
                                    Reservasi Pemesanan
                                </h2>
                                <p
                                    class="self-stretch mt-7 text-sm tracking-tight leading-6 text-center"
                                >
        ...
        <section class="">
            ...
            >
                ...
                <section
                    class="flex flex-col w-full items-center px-20 pt-16 pb-20 bg-red-200 max-md:px-5 max-md:pt-24"
                >
                    <h1
                    ...
                    <div class="mt-12 max-md:mt-10 max-md:max-w-full">
                        <div class="flex gap-5 max-md:flex-col max-md:gap-8">
                            <div
                                class="flex flex-col w-3/12 max-md:w-full max-md:mb-8"
                            >
                                <div class="flex flex-col grow max-md:mt-8">
                                    ...
                                    >
                                        ...
                                        />
                                        <button
                                            class="gap-2 self-center px-5 mt-5 text-base font-semibold tracking-tight text-center text-red-400 bg-orange-100 rounded min-h-[44px] w-[150px]"
                                        >
                                            Pesan Sekarang
                                        </button>
                                    </div>
                            ...
                            >
                                <div class="flex flex-col grow max-md:mt-8">
                                    ...
                                    >
                                        ...
                                        <button
                                            class="gap-2 self-center px-5 mt-4 text-base font-semibold tracking-tight text-center text-red-400 bg-orange-100 rounded min-h-[44px] w-[150px]"
                                        >
                                            Pesan Sekarang
                                        </button>
                                    </div>
                            ...
                            >
                                <div class="flex flex-col grow max-md:mt-8">
                                    ...
                                    >
                                        ...
                                        />
                                        <button
                                            class="gap-2 self-center px-5 mt-7 text-base font-semibold tracking-tight text-center text-red-400 bg-orange-100 rounded min-h-[44px] w-[150px]"
                                        >
                                            Pesan Sekarang
                                        </button>
                                    </div>
                            ...
                            >
                                <div class="flex flex-col grow max-md:mt-8">
                                    ...
                                    >
                                        ...
                                        />
                                        <button
                                            class="gap-2 self-center px-5 mt-8 text-base font-semibold tracking-tight text-center text-red-400 bg-orange-100 rounded min-h-[44px] w-[150px]"
                                        >
                                            Pesan Sekarang
                                        </button>
                                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                cinta dan perhatian, menjadikan hari spesial
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        mudah diakses dan
                                                        jangkauan luas, kami
                                                        siap membantu kebutuhan
                                                        bunga Anda kapan saja.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                <section class="flex flex-col rounded-none overflow-x-hidden">
                    <TestimonialSection />
                </section>
            </div>
        </section>
...
<style scoped>
/* Ensure the section does not exceed the screen width */
section {
    width: 100%;
    max-width: 100vw;
    overflow-x: hidden;
